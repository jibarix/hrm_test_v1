...
def convert_dataset(config: DataProcessConfig):
    ...
    inputs_data = json.load(open(f"{config.source_dir}/diverse_pathfinding_1000ex_train_all__inputs.json"))
    labels_data = json.load(open(f"{config.source_dir}/diverse_pathfinding_1000ex_train_all__labels.json"))
    puzzle_identifiers_data = json.load(open(f"{config.source_dir}/diverse_pathfinding_1000ex_train_all__puzzle_identifiers.json"))
    puzzle_indices_data = json.load(open(f"{config.source_dir}/diverse_pathfinding_1000ex_train_all__puzzle_indices.json"))
    group_indices_data = json.load(open(f"{config.source_dir}/diverse_pathfinding_1000ex_train_all__group_indices.json"))
    metadata = json.load(open(f"{config.source_dir}/diverse_pathfinding_1000ex_train_dataset.json"))
...
def main(config: DataProcessConfig):
    ...
    required_files = [
        "diverse_pathfinding_1000ex_train_all__inputs.json",
        "diverse_pathfinding_1000ex_train_all__labels.json", 
        "diverse_pathfinding_1000ex_train_all__puzzle_identifiers.json",
        "diverse_pathfinding_1000ex_train_all__puzzle_indices.json",
        "diverse_pathfinding_1000ex_train_all__group_indices.json",
        "diverse_pathfinding_1000ex_train_dataset.json"
    ]
