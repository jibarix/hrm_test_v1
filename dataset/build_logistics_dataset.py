...
class DataProcessConfig(BaseModel):
    source_dir: str = "dataset/raw-data/SimplePathfinding"  # Where you saved the JSON files
    output_dir: str = "data/simple-pathfinding-1k"
    
def convert_dataset(config: DataProcessConfig):
    # Read the JSON files generated by simplified logistics game
    inputs_data = json.load(open(f"{config.source_dir}/simple_pathfinding_1000ex_train_all__inputs.json"))
    labels_data = json.load(open(f"{config.source_dir}/simple_pathfinding_1000ex_train_all__labels.json"))
    puzzle_identifiers_data = json.load(open(f"{config.source_dir}/simple_pathfinding_1000ex_train_all__puzzle_identifiers.json"))
    puzzle_indices_data = json.load(open(f"{config.source_dir}/simple_pathfinding_1000ex_train_all__puzzle_indices.json"))
    group_indices_data = json.load(open(f"{config.source_dir}/simple_pathfinding_1000ex_train_all__group_indices.json"))
    metadata = json.load(open(f"{config.source_dir}/simple_pathfinding_1000ex_train_dataset.json"))
...
def main(config: DataProcessConfig):
    ...
    dataset/raw-data/SimplePathfinding/
    ├── simple_pathfinding_1000ex_train_all__inputs.json
    ├── simple_pathfinding_1000ex_train_all__labels.json  
    ├── simple_pathfinding_1000ex_train_all__puzzle_identifiers.json
    ├── simple_pathfinding_1000ex_train_all__puzzle_indices.json
    ├── simple_pathfinding_1000ex_train_all__group_indices.json
    ├── simple_pathfinding_1000ex_train_dataset.json
    └── identifiers.json
